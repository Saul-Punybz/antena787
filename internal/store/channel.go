...
func scanChannel(sc interface{ Scan(...any) error }) (model.Channel, error) {
	...
	err := sc.Scan(&c.ID, &c.Name, &c.Kind, &c.FormatProfile, &c.RegProfile, &c.Mode,
		...
		&c.CallSign, &c.LicenseCity, &c.LicenseClass, &c.Accel, &c.VirtualChannel)
	if err != nil {
